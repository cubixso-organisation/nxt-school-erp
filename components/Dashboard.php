...
class Dashboard extends Component
{
    ...
    public function addDashboardNotification($description = '', $title = '', $user_id = '', $campus_id = '', $url = '')
    {
        $dashboard_notification = new DashboardNotification();
        $dashboard_notification->user_id  = $user_id;
        $dashboard_notification->campus_id = $campus_id;
        $dashboard_notification->title = $title;
        $dashboard_notification->description = $description;
        $dashboard_notification->url = $url;
        $dashboard_notification->is_read = $dashboard_notification::IS_NOT_READ;
        $dashboard_notification->status = $dashboard_notification::STATUS_ACTIVE;
        $dashboard_notification->save(false);
    }
}
