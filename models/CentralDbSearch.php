...
/**
 * app\models\CentralDbSearch represents the model behind the search form about `app\models\CentralDb`.
 */
 class CentralDbSearch extends CentralDb
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['name', 'email', 'phone', 'school_name', 'address', 'domain', 'db_username', 'db_password', 'db_name', 'sub_domain', 'status', 'created_on', 'updated_on'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'sub_domain', $this->sub_domain])
