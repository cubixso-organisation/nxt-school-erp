...
use app\modules\exammanagement\models\MarksDivitionSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MarksDivitionController implements the CRUD actions for MarksDivition model.
 */
class MarksDivitionController extends Controller
{
    ...
    /**
     * Lists all MarksDivition models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MarksDivitionSearch();
    ...
    /**
     * Displays a single MarksDivition model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MarksDivition model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new MarksDivition();
    ...
    /**
     * Updates an existing MarksDivition model.
    ...
    /**
     * Deletes an existing MarksDivition model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = MarksDivition::STATUS_DELETE;
            $model->save(false);
        }
    ...
    public function actionUpdateStatus()
    {
        ...
        if (! empty($post['id'])) {
            $model = MarksDivition::find()->where([
                'id' => $post['id'],
            ])->one();
            if (!empty($model)) {
    ...
    /**
     * Finds the MarksDivition model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MarksDivition the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MarksDivition::findOne($id)) !== null) {
            return $model;
        } else {
