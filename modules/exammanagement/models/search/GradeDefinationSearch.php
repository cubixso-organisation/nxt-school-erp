...
/**
 * app\modules\exammanagement\models\search\GradeDefinationSearch represents the model behind the search form about `app\modules\exammanagement\models\GradeDefination`.
 */
 class GradeDefinationSearch extends GradeDefination
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'grade_id', 'section_id', 'campus_id', 'create_user_id', 'update_user_id'], 'integer'],
