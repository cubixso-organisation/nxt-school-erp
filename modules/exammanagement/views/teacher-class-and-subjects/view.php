...
?>
<div class="teacher-class-and-subjects-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Teacher Class And Subjects').' '. Html::encode($this->title) ?></h2>
        </div>
...
<?php 
    $gridColumn = [
        ...
        [
            'attribute' => 'teacherDetail.name',
            'label' => Yii::t('app', 'Teacher Detail'),
        ],
        [
            'attribute' => 'teacherUser.username',
