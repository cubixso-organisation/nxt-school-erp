...
/* @var $searchModel app\modules\exammanagement\models\MarksDivitionSearch */
...
$this->title = Yii::t('app', 'Marks Divitions');
...
?>
<div class="marks-divition-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN || \Yii::$app->user->identity->user_role==User::role_campus_sub_admin){ ?>
        <?= Html::a(Yii::t('app', 'Create Marks Divition'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-marks-divition']],
        'panel' => [
