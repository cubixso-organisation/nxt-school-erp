...
/* @var $searchModel app\modules\exammanagement\models\search\GradeDefinationSearch */
...
$this->title = Yii::t('app', 'Grade Definations');
...
?>
<div class="grade-defination-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Grade Defination'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){                   
                    return $model->grade0->id;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\exammanagement\models\Grade::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Grade', 'id' => 'grid-grade-defination-search-grade_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-grade-defination-search-section_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-grade-defination-search-campus_id']
            ],
