...
/**
 * app\modules\staffmanagement\models\search\SalaryGroupsSearch represents the model behind the search form about `app\modules\staffmanagement\models\SalaryGroups`.
 */
class SalaryGroupsSearch extends SalaryGroups
{
    ...
    {
        $query = SalaryGroups::find()->where(['campus_id' => (new User())->getCampusId()]);
