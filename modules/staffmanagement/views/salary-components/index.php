...
/* @var $searchModel app\modules\staffmanagement\models\search\SalaryComponentsSearch */
...
?>
<div class="salary-components-index">
    <div class="card">
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) { ?>
                    <?= Html::a('Create Salary Components', ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'value' => function ($model) {
                        return $model->getComponentTypeOptionsBadges();
                    },
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($model) {
                        return $model->getValueTypeOptionsBadges();
                    },
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-salary-components']],
                'panel' => [
