...
/* @var $searchModel app\modules\inventory\models\search\AddItemStockSearch */
...
$this->title = Yii::t('app', 'Add Item Stocks');
...
?>
<div class="add-item-stock-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Add Item Stock'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Item category', 'id' => 'grid-add-item-stock-search-item_category_id']
            ],
   
        [
                'attribute' => 'item_supplier_list_id',
                'label' => Yii::t('app', 'Item Supplier List'),
                'value' => function($model){                   
                    return $model->itemSupplierList->name;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\inventory\models\ItemSupplierList::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Item supplier list', 'id' => 'grid-add-item-stock-search-item_supplier_list_id']
            ],
   
        [
                'attribute' => 'item_store_id',
                'label' => Yii::t('app', 'Item Store'),
                'value' => function($model){                   
                    return $model->itemStore->item_store_name;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\inventory\models\ItemStore::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Item store', 'id' => 'grid-add-item-stock-search-item_store_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Inventory items', 'id' => 'grid-add-item-stock-search-inventory_items_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-add-item-stock']],
        'panel' => [
