...
/* @var $searchModel app\modules\inventory\models\search\InventoryItemsSearch */
        ...
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Inventory Items'), ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Item category', 'id' => 'grid-inventory-items-search-item_category_id']
                ],
                ...
                [
                    ...
                    'label' => Yii::t('app', 'Available Quantity'),
                    'value' => function ($model) {
                        $stockItems =  (new InventoryItems())->getAvailableStock($model->id);

                        return $stockItems['quantity_left'];
                    },
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-inventory-items']],
                'panel' => [
