...
use app\modules\inventory\models\search\ItemStoreSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ItemStoreController implements the CRUD actions for ItemStore model.
 */
class ItemStoreController extends Controller
{
    ...
    /**
     * Displays a single ItemStore model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing ItemStore model.
    ...
    /**
     * Deletes an existing ItemStore model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if(!empty($model)){
            $model->status = ItemStore::STATUS_DELETE;
            $model->save(false); 
        }
    ...
    /**
     * Finds the ItemStore model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ItemStore the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ItemStore::findOne($id)) !== null) {
            return $model;
        } else {
