...
use app\modules\librarymanagement\models\search\LibraryBooksSearch;
...
// var_dump(\Yii::$app->user->identity->id);exit;
    ...
    public function actionCreate()
    {
        ...
        if ($model->loadAll(Yii::$app->request->post())) {
            // $model->campus_id = (new User())->getUserCampusId();
            $model->save(false);
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = LibraryBooks::STATUS_DELETE;
            $model->save(false);
        }
