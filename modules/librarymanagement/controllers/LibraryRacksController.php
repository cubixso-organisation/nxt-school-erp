...
use app\modules\librarymanagement\models\search\LibraryRacksSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * LibraryRacksController implements the CRUD actions for LibraryRacks model.
 */
class LibraryRacksController extends Controller
{
    ...
    /**
     * Lists all LibraryRacks models.
     * @return mixed
     */
    public function actionIndex()
    {

        $searchModel = new LibraryRacksSearch();
    ...
    /**
     * Displays a single LibraryRacks model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new LibraryRacks model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new LibraryRacks();

        if ($model->loadAll(Yii::$app->request->post())) {
            $user_role = User::find()->where(['user_role' => User::ROLE_LIBRARIAN])->andWhere(['id' => Yii::$app->user->identity->id])->one();
            if (!empty($user_role)) {
                $model->campus_id = (new User)->getUserCampusId();
            } else {
                $model->campus_id = (new User)->getCampusId();
            }
            // var_dump((new User)->getUserCampusId());
            // exit;
            $model->save(false);
    ...
    /**
     * Updates an existing LibraryRacks model.
    ...
    /**
     * Deletes an existing LibraryRacks model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = LibraryRacks::STATUS_DELETE;
            $model->save(false);
        }
    ...
    /**
     * Finds the LibraryRacks model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LibraryRacks the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LibraryRacks::findOne($id)) !== null) {
            return $model;
        } else {
