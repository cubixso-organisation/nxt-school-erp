...
/* @var $searchModel app\modules\librarymanagement\models\search\LibrarySchoolsWiseSearch */
...
$this->title = Yii::t('app', 'Library Schools Wises');
...
?>
<div class="library-schools-wise-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Library Schools Wise'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-library-schools-wise']],
        'panel' => [
