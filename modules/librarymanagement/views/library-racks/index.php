...
/* @var $searchModel app\modules\librarymanagement\models\search\LibraryRacksSearch */
...
$this->title = Yii::t('app', 'Library Racks');
        ...
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_LIBRARIAN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Library Racks'), ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-library-racks']],
                'panel' => [
