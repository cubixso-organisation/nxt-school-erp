...
use Yii;
use app\models\User;
use app\modules\childassessment\models\ChildMerit;
use app\modules\childassessment\models\search\ChildMeritSearch;
 ...
 */
class ChildMeritController extends Controller
{
    ...
    /**
     * Lists all ChildMerit models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ChildMeritSearch();
    ...
    /**
     * Displays a single ChildMerit model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ChildMerit model.
    ...
    /**
     * Updates an existing ChildMerit model.
    ...
    /**
     * Deletes an existing ChildMerit model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if(!empty($model)){
            $model->status = ChildMerit::STATUS_DELETE;
            $model->save(false); 
        }
    ...
    /**
     * Finds the ChildMerit model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ChildMerit the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ChildMerit::findOne($id)) !== null) {
            return $model;
        } else {
