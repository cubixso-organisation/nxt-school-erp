...
use app\modules\admin\models\search\SpecialDaysSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SpecialDaysController implements the CRUD actions for SpecialDays model.
 */
class SpecialDaysController extends Controller
{
    ...
    /**
     * Lists all SpecialDays models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SpecialDaysSearch();
    ...
    /**
     * Displays a single SpecialDays model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SpecialDays model.
    ...
    /**
     * Updates an existing SpecialDays model.
    ...
    /**
     * Deletes an existing SpecialDays model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = SpecialDays::STATUS_DELETE;
            $model->save(false);
        }
    ...
    /**
     * Finds the SpecialDays model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SpecialDays the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SpecialDays::findOne($id)) !== null) {
            return $model;
        } else {
