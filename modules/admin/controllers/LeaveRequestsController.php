...
use app\modules\admin\models\search\LeaveRequestsSearch;
...
class LeaveRequestsController extends Controller
{
    ...
    {
        $searchModel = new LeaveRequestsSearch();
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = LeaveRequests::STATUS_DELETE;
            $model->save(false);
        }
    ...
    public function actionUpdateStatus()
    {
        ...
        if (!empty($post['id'])) {
            $model = LeaveRequests::find()->where([
                'id' => $post['id'],
            ])->one();
            if (!empty($model)) {
