...
use app\modules\admin\models\DaycareAttendanceSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DaycareAttendanceController implements the CRUD actions for DaycareAttendance model.
 */
class DaycareAttendanceController extends Controller
{
    ...
    /**
     * Lists all DaycareAttendance models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DaycareAttendanceSearch();
    ...
    /**
     * Displays a single DaycareAttendance model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new DaycareAttendance model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new DaycareAttendance();
    ...
    /**
     * Updates an existing DaycareAttendance model.
    ...
    /**
     * Deletes an existing DaycareAttendance model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if(!empty($model)){
            $model->status = DaycareAttendance::STATUS_DELETE;
            $model->save(false); 
        }
    ...
    public function actionUpdateStatus(){
		...
		if (! empty ( $post ['id'] ) ) {
			$model = DaycareAttendance::find()->where([
				'id' => $post['id'],
			])->one();
			if(!empty($model)){
    ...
    /**
     * Finds the DaycareAttendance model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DaycareAttendance the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DaycareAttendance::findOne($id)) !== null) {
            return $model;
        } else {
