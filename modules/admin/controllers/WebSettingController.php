...
use app\modules\admin\models\WebSettingSearch as ModelsWebSettingSearch;
...
class WebSettingController extends Controller
{
    ...
    {
        $searchModel = new ModelsWebSettingSearch();
    ...
    public function actionCms()
    {
        ...
        $paypal_setting = WebSetting::find()->where([
            'type_id' => WebSetting::PAYPAL_SETTING
        ])->all();
        $notification = WebSetting::find()->where([
            'type_id' => WebSetting::NOTIFICATION
        ])->all();
        $payment_gateway = WebSetting::find()->where([
            'type_id' => WebSetting::PAYMENT_GATEWAY
        ])->all();
