...
class NotificationController extends Controller
{
                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function () {
                            return User::isAdmin() || User::isCampusAdmin() || User::isCampusSubAdmin() || User::isInstituteAdmin();;
                        }
    ...
    public function actionIndex()
    {
        ...
        if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_INSTITUTE_ADMIN) {
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = Notification::STATUS_DELETE;
            $model->save(false);
        }
