...
use Yii;
use app\models\User;
use app\modules\admin\models\StudentAnswers;
use app\modules\admin\models\StudentAnswersSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * StudentAnswersController implements the CRUD actions for StudentAnswers model.
 */
class StudentAnswersController extends Controller
{
    ...
    /**
     * Lists all StudentAnswers models.
     * @return mixed
     */
    ...
    /**
     * Displays a single StudentAnswers model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new StudentAnswers model.
    ...
    /**
     * Updates an existing StudentAnswers model.
    ...
    /**
     * Deletes an existing StudentAnswers model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if(!empty($model)){
            $model->status = StudentAnswers::STATUS_DELETE;
            $model->save(false); 
        }
    ...
    public function actionUpdateStatus(){
		...
		if (! empty ( $post ['id'] ) ) {
			$model = StudentAnswers::find()->where([
				'id' => $post['id'],
			])->one();
			if(!empty($model)){
    ...
    /**
     * Finds the StudentAnswers model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return StudentAnswers the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = StudentAnswers::findOne($id)) !== null) {
            return $model;
        } else {
