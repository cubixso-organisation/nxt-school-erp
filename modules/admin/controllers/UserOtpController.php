...
use app\modules\admin\models\search\UserOtpSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * UserOtpController implements the CRUD actions for UserOtp model.
 */
class UserOtpController extends Controller
{
    ...
    /**
     * Lists all UserOtp models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new UserOtpSearch();
    ...
    /**
     * Displays a single UserOtp model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing UserOtp model.
    ...
    /**
     * Deletes an existing UserOtp model.
    ...
    public function actionDelete($id)
    {
        ...
        $model = $this->findModel($id);
        if (!empty($model)) {
            $model->status = UserOtp::STATUS_DELETE;
            $model->save(false);
        }
    ...
    /**
     * Finds the UserOtp model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return UserOtp the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = UserOtp::findOne($id)) !== null) {
            return $model;
        } else {
