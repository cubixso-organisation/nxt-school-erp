...
class Menu extends \yii\widgets\Menu
{
	...
	public $linkTemplate = '<a  href="{url}" {attributes}>{icon} <p>{label} {arrow}</p></a>';
	...
	public $submenuTemplate ='<li><a href="students.html">Student List</a></li>';
