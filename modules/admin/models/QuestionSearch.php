...
/**
 * app\modules\admin\models\QuestionSearch represents the model behind the search form about `app\modules\admin\models\Question`.
 */
 class QuestionSearch extends Question
{
    ...
    public function rules()
    {
        return [
            ...
            [['question_text', 'created_on', 'updated_on'], 'safe'],
        ];
    }
