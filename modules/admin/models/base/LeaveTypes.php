...
/**
 * This is the base model class for table "leave_types".
 *
 * @property integer $id
...
class LeaveTypes extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\LeaveTypesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\LeaveTypesQuery(get_called_class());
    }
public function asJson(){
    $data = [] ; 
            $data['leave_type_id'] =  $this->id;
