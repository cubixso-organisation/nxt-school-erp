...
/**
 * This is the base model class for table "class_rooms".
 *
 * @property integer $id
 * @property integer $campus_id
 * @property string $class_room_title
    ...
    */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'class_room_title' => Yii::t('app', 'Class Room Title'),
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\ClassRoomsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\ClassRoomsQuery(get_called_class());
    }
public function asJson(){
    $data = [] ; 
            $data['id'] =  $this->id;
                ...
                $data['class_room_title'] =  $this->class_room_title;
