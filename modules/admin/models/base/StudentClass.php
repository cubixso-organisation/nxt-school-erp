...
class StudentClass extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['campus_id', 'title', 'status'], 'required'],
    ...
    {
        return $this->hasMany(\app\modules\admin\models\ClassSections::className(), ['student_class_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\FeeStructures::className(), ['student_class_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\StudentDetails::className(), ['student_class_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\StudentClassQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\StudentClassQuery(get_called_class());
    }
