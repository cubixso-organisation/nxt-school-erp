...
/**
 * This is the base model class for table "special_courses".
 *
 * @property integer $id
 ...
 */
class SpecialCourses extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['campus_id', 'course_name'], 'required'],
    ...
    {
        return $this->hasMany(\app\modules\admin\models\StudentSpecialCourses::className(), ['special_courses_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\SpecialCoursesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\SpecialCoursesQuery(get_called_class());
    }
