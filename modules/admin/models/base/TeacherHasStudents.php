...
/**
 * This is the base model class for table "teacher_has_students".
 *
 * @property integer $id
 ...
 */
class TeacherHasStudents extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\TeacherHasStudentsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\TeacherHasStudentsQuery(get_called_class());
    }
