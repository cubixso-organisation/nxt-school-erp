...
class Expenses extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['amount', 'student_id', 'item_description', 'status',], 'required'],
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\ExpensesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\ExpensesQuery(get_called_class());
    }
