...
/**
 * This is the base model class for table "special_days".
 *
 * @property integer $id
 ...
 */
class SpecialDays extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\SpecialDaysQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\SpecialDaysQuery(get_called_class());
    }
