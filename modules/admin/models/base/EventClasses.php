...
/**
 * This is the base model class for table "event_classes".
 *
 * @property integer $id
...
class EventClasses extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasOne(\app\modules\admin\models\Events::className(), ['id' => 'event_id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\EventClassesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\EventClassesQuery(get_called_class());
    }
