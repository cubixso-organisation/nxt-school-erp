...
/**
 * This is the base model class for table "login_logs".
 *
 * @property integer $id
...
class LoginLogs extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\LoginLogsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\LoginLogsQuery(get_called_class());
    }
