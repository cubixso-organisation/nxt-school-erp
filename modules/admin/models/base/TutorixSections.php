...
/**
 * This is the base model class for table "tutorix_sections".
 *
 * @property integer $id
 ...
 */
class TutorixSections extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\app\modules\admin\models\TutorixLectures::className(), ['section_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\TutorixSectionsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\TutorixSectionsQuery(get_called_class());
    }
