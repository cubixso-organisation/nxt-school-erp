...
/**
 * This is the base model class for table "student_special_courses".
 *
 * @property integer $id
 ...
 */
class StudentSpecialCourses extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['campus_id', 'student_id', 'special_courses_id'], 'required'],
            [['campus_id', 'student_id', 'special_courses_id', 'create_user_id', 'update_user_id'], 'integer'],
    ...
    {
        return 'student_special_courses';
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\StudentSpecialCoursesQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\StudentSpecialCoursesQuery(get_called_class());
    }
