    ...
    */
    ...
    public function rules()
    {
        return [
            ...
            [['country_id', 'status', 'create_user_id', 'update_user_id'], 'integer'],
    ...
    {
        return $this->hasMany(\app\modules\admin\models\District::className(), ['state_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\StateQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\StateQuery(get_called_class());
    }
