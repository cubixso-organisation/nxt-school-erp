    ...
    */
    ...
    public function rules()
    {
        return [
            ...
            [['created_on', 'updated_on','student_names','student_classes'], 'safe'],
            [['parent_name', 'contact_no', 'campus_id','campus_name'], 'safe'],
            [['auth_code', 'type_id','device_token'], 'string', 'max' => 256]
        ];
    }
