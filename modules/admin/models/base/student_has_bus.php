 ...
 */
class student_has_bus extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['student_id', 'bus_id', 'bus_route_id', 'status'], 'required'],
            [['student_id', 'bus_id', 'bus_route_id', 'status', 'create_user_id', 'update_user_id'], 'integer'],
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\student_has_busQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\student_has_busQuery(get_called_class());
    }
