...
/**
 * This is the base model class for table "academic_years".
 *
 * @property integer $id
...
class AcademicYears extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['campus_id', 'title', 'year_from', 'year_to'], 'required'],
            [['campus_id', 'status', 'create_user_id', 'update_user_id'], 'integer'],
            [['year_from', 'year_to', 'created_on', 'updated_on'], 'safe'],
    ...
    {
        return $this->hasMany(\app\modules\admin\models\PayFees::className(), ['academic_year_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\StudentClassAttendance::className(), ['academic_year_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\StudentDetails::className(), ['academic_year_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\app\modules\admin\models\TeacherDetails::className(), ['academic_year_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\AcademicYearsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\AcademicYearsQuery(get_called_class());
    }
