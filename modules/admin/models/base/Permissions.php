...
class Permissions extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\modules\admin\models\RoleHasPermissions::className(), ['permission_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\admin\models\PermissionsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\admin\models\PermissionsQuery(get_called_class());
    }
