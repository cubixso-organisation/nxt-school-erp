...
/**
 * app\modules\admin\models\search\ClassSectionsSearch represents the model behind the search form about `app\modules\admin\models\ClassSections`.
 */
class ClassSectionsSearch extends ClassSections
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'campus_id', 'student_class_id', 'status', 'create_user_id', 'update_user_id'], 'integer'],
            [['section_name', 'created_on', 'updated_on'], 'safe'],
        ];
    }
