...
/**
 * app\modules\admin\models\search\BannersSearch represents the model behind the search form about `app\modules\admin\models\Banners`.
 */
 class BannersSearch extends Banners
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'image', 'url', 'created_on', 'updated_on'], 'safe'],
        ];
    }
