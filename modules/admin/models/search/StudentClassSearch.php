...
/**
 * app\modules\admin\models\search\StudentClassSearch represents the model behind the search form about `app\modules\admin\models\StudentClass`.
 */
 class StudentClassSearch extends StudentClass
{
    ...
    public function campusSearch($params,$is_agent='')
    {
        $query = StudentClass::find()
                     ...
                     if(!empty($is_agent)){
                        $query->andWhere(['is_agent'=>$is_agent]);
                     }else{
