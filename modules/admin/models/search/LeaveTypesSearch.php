...
/**
 * app\modules\admin\models\search\LeaveTypesSearch represents the model behind the search form about `app\modules\admin\models\LeaveTypes`.
 */
 class LeaveTypesSearch extends LeaveTypes
{
    ...
    public function campusSubAdminSearch($params)
    {
        ...
        $query = LeaveTypes::find()->where(['campus_id'=> $campuses]);
