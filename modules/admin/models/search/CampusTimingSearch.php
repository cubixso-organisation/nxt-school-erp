...
/**
 * app\modules\admin\models\search\CampusTimingSearch represents the model behind the search form about `app\modules\admin\models\CampusTiming`.
 */
 class CampusTimingSearch extends CampusTiming
{
    /**
     * @inheritdoc
     */
