...
/**
 * app\modules\admin\models\search\DesignationSearch represents the model behind the search form about `app\modules\admin\models\Designation`.
 */
class DesignationSearch extends Designation
{
     ...
     */
    public function search($params,$campus_id='',$institutes_id='')
    {
        ...
        if(!empty($institutes_id)){
            ...
            $query->where(['in','campus_id',$campusIds]);
