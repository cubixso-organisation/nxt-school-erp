...
/**
 * app\modules\admin\models\search\SubjectsSearch represents the model behind the search form about `app\modules\admin\models\Subjects`.
 */
 class SubjectsSearch extends Subjects
{
    ...
    {
        return [
            [['id', 'campus_id', 'subject_type', 'status', 'create_user_id', 'update_user_id'], 'integer'],
            [['subject_name', 'subject_code', 'created_on', 'updated_on'], 'safe'],
        ];
    }
    ...
    {
        $query = Subjects::find()->Where(['campus_id'=> (new User())->getCampusId()]);
