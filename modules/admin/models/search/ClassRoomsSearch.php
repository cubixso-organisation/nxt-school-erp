...
/**
 * app\modules\admin\models\search\ClassRoomsSearch represents the model behind the search form about `app\modules\admin\models\ClassRooms`.
 */
 class ClassRoomsSearch extends ClassRooms
{
    ...
    public function rules()
    {
        return [
            ...
            [['class_room_title', 'created_on', 'updated_on'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'class_room_title', $this->class_room_title]);
    ...
    public function campusSubAdminSearch($params)
    {
        ...
        $query = ClassRooms::find()->where(['campus_id'=> $campuses]);
