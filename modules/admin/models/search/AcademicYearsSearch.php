...
/**
 * app\modules\admin\models\search\AcademicYearsSearch represents the model behind the search form about `app\modules\admin\models\AcademicYears`.
 */
 class AcademicYearsSearch extends AcademicYears
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'year_from', 'year_to', 'created_on', 'updated_on'], 'safe'],
        ];
    }
