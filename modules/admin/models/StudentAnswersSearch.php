...
/**
 * app\modules\admin\models\StudentAnswersSearch represents the model behind the search form about `app\modules\admin\models\StudentAnswers`.
 */
 class StudentAnswersSearch extends StudentAnswers
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['answer_text', 'created_on', 'updated_on'], 'safe'],
        ];
    }
