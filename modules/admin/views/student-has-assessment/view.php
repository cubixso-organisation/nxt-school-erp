...
?>
<div class="student-has-assessment-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Student Has Assessment').' '. Html::encode($this->title) ?></h2>
        </div>
...
<?php 
    $gridColumn = [
        ...
        [
            'attribute' => 'studentAssessment.id',
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>StudentAssessment<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnStudentAssessment = [
        ['attribute' => 'id', 'visible' => false],
        'campus_id',
        'teacher_details_id',
    ...
    echo DetailView::widget([
        'model' => $model->studentAssessment,
        'attributes' => $gridColumnStudentAssessment    ]);
    ?>
    </div>
    </div>
</div>
