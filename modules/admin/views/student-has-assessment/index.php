...
/* @var $searchModel app\modules\admin\models\search\StudentHasAssessmentSearch */
...
$this->title = Yii::t('app', 'Student Has Assessments');
...
?>
<div class="student-has-assessment-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Student Has Assessment'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Student details', 'id' => 'grid-student-has-assessment-search-student_id']
            ],
   
        [
                'attribute' => 'student_assessment_id',
                'label' => Yii::t('app', 'Student Assessment'),
                'value' => function($model){                   
                    return $model->studentAssessment->id;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\StudentAssessment::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Student assessment', 'id' => 'grid-student-has-assessment-search-student_assessment_id']
            ],
