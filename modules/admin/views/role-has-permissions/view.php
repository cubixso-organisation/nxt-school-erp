...
?>
<div class="role-has-permissions-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Role Has Permissions').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>Permissions<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    ...
    echo DetailView::widget([
        ...
        'attributes' => $gridColumnPermissions    ]);
    ?>
    </div>
    </div>
</div>
