...
<div class="card">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Designation').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="row">
<?php
if($providerEmployeeDetails->totalCount){
    $gridColumnEmployeeDetails = [
    ...
    echo Gridview::widget([
        'dataProvider' => $providerEmployeeDetails,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-employee-details']],
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('app', 'Employee Details')),
        ],
        'export' => false,
        'columns' => $gridColumnEmployeeDetails
    ]);
}
