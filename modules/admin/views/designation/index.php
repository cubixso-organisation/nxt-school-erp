...
/* @var $searchModel app\modules\admin\models\search\DesignationSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-designation-search-campus_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-designation']],
        'panel' => [
