...
/* @var $searchModel app\modules\admin\models\search\StudentHasDairySearch */
...
$this->title = Yii::t('app', 'Student Has Dairies');
...
?>
<div class="student-has-dairy-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Student Has Dairy'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Student details', 'id' => 'grid-student-has-dairy-search-student_id']
            ],
   
        [
                'attribute' => 'student_dairy_id',
                'label' => Yii::t('app', 'Student Dairy'),
                'value' => function($model){                   
                    return $model->studentDairy->id;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\StudentDairy::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Student dairy', 'id' => 'grid-student-has-dairy-search-student_dairy_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-student-has-dairy']],
        'panel' => [
