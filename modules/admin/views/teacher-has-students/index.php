...
/* @var $searchModel app\modules\admin\models\search\TeacherHasStudentsSearch */
...
$this->title = Yii::t('app', 'Teacher Has Students');
...
?>
<div class="teacher-has-students-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_SUBADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Teacher Has Students'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Teacher details', 'id' => 'grid-teacher-has-students-search-teacher_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Student details', 'id' => 'grid-teacher-has-students-search-student_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-teacher-has-students']],
        'panel' => [
