...
/* @var $searchModel app\modules\admin\models\search\StudentNoticeBoardsSearch */
...
$this->title = Yii::t('app', 'Student Notice Boards');
...
?>
<div class="student-notice-boards-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Student Notice Boards'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
          ...
          [
                ...
                'filterInputOptions' => ['placeholder' => 'Class sections', 'id' => 'grid-student-notice-boards-search-section_id']
            ],
        ...
        [
                ...
                'value' => function($model){                   
                    return $model->teacherDetails ? $model->teacherDetails->name : null;                 
                },
                'filterType' => GridView::FILTER_SELECT2,
                ...
                'filterInputOptions' => ['placeholder' => 'Teacher details', 'id' => 'grid-student-notice-boards-search-teacher_details_id']
            ],
            ...
            [
                ...
                'filter'  =>  (new StudentNoticeBoards())->getStateOptions(),
                'filterType' => GridView::FILTER_SELECT2,
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-student-notice-boards']],
        'panel' => [
