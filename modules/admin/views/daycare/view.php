...
<div class="card">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Daycare').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="row">
<?php
if($providerDaycareTeachers->totalCount){
    $gridColumnDaycareTeachers = [
    ...
    echo Gridview::widget([
        'dataProvider' => $providerDaycareTeachers,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-daycare-teachers']],
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('app', 'Daycare Teachers')),
        ],
        'export' => false,
        'columns' => $gridColumnDaycareTeachers
    ]);
}
