...
/* @var $searchModel app\modules\admin\models\search\UserOtpSearch */
...
$this->title = Yii::t('app', 'User Otps');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create User Otp'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-user-otp']],
        'panel' => [
