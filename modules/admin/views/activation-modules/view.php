...
?>
<div class="activation-modules-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Activation Modules').' '. Html::encode($this->title) ?></h2>
        </div>
...
if($providerCampus->totalCount){
    $gridColumnCampus = [
        ['class' => 'yii\grid\SerialColumn'],
            ...
            [
                'attribute' => 'subscriptionType.title',
                'label' => Yii::t('app', 'Subscription Type')
            ],
                        'lat',
            'lng',
            'city',
