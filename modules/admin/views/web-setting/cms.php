...
<div class="row">
  <div class="col-md-12">
	...
	<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#url_setting" role="tab" aria-controls="nav-contact" aria-selected="false">By-pass Numbers</a>
	...
	<!-- <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#social_login" role="tab" aria-controls="nav-contact" aria-selected="false">By-Pass Numbers</a> -->
