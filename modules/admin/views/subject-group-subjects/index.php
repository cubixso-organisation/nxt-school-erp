...
/* @var $searchModel app\modules\admin\models\search\SubjectGroupSubjectsSearch */
...
$this->title = Yii::t('app', 'Subject Group Subjects');
...
?>
<div class="subject-group-subjects-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Subject Group Subjects'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Subject groups', 'id' => 'grid-subject-group-subjects-search-subject_group_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Subjects', 'id' => 'grid-subject-group-subjects-search-subject_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Academic years', 'id' => 'grid-subject-group-subjects-search-academic_year_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-subject-group-subjects']],
        'panel' => [
