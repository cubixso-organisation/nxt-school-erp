...
/* @var $searchModel app\modules\admin\models\search\StateSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Country', 'id' => 'grid-state-search-country_id']
            ],
        ...
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => (new State())->getStateOptions(),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-state']],
        'panel' => [
