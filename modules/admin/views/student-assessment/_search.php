...
/* @var $model app\modules\admin\models\search\StudentAssessmentSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-student-assessment-search">
    ...
    <?= $form->field($model, 'subject_timetable_id')->textInput(['placeholder' => 'Subject Timetable']) ?>
    ...
    <?php /* echo $form->field($model, 'assessment')->textarea(['rows' => 6]) */ ?>
