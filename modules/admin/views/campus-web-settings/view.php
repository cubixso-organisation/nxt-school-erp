...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Campus Web Settings'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="campus-web-settings-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Campus Web Settings').' '. Html::encode($this->title) ?></h2>
        </div>
