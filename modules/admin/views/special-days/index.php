...
/* @var $searchModel app\modules\admin\models\search\SpecialDaysSearch */
...
$this->title = Yii::t('app', 'Special Days');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Special Days'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-special-days-search-campus_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Academic years', 'id' => 'grid-special-days-search-academic_year_id']
            ],
        ...
        [
            ...
            'filter'  =>  (new SpecialDays())->getStateOptions(),
            'filterType' => GridView::FILTER_SELECT2,
            'filterWidgetOptions' => [
                'pluginOptions' => ['allowClear' => true],
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-special-days']],
        'panel' => [
