...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\BusRoute::find()->asArray()->all(), 'id', 'point_name'),
                'filterWidgetOptions' => [
        ...
        [
            ...
            'view'=> function($url,$model) {
                $url = Url::toRoute(['/admin/student-attendance-bus/view','id'=>$model->id]);
