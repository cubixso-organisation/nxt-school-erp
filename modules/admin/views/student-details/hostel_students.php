...
use app\models\User;
use app\modules\admin\models\base\PocketMoney;
...
$this->title = Yii::t('app', 'Hostel Students');
...
<div class="student-details-index">
    ...
    $gridColumn = [
        ...
        [
            ...
            'attribute' => 'status',
            'label' => Yii::t('app', 'Update Pocket Money'),
            'format' => 'raw',
            'value' => function ($model) {
                return "<a href='" . Url::to(['pocket-money/create', 'student_id' => $model->id]) . "' class='btn btn-primary'>Update Pocket Money</a>";
            },
        ...
        [
            ...
            'attribute' => 'status',
            'label' => Yii::t('app', 'Available Pocket Money'),
            'format' => 'raw',
            'value' => function ($model) {
                return (new PocketMoney())->getPendingAmount($model->id, $model->campus_id);
            },
