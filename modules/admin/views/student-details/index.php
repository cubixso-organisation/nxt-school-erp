...
<div class="student-details-index">
    ...
    <a href="<?= Url::base() ?>/web/files/file_example_XLS_10.xls">Example Format Download</a>
    </p>
    ...
    $gridColumn = [
        ...
        [
            ...
            'value' => function ($model) {
                ...
                $phone = preg_replace('/\D/', '', $model->phone_number);

                // Default message
                $name = $model->student_name;
                $schoolName = $model->campus ? $model->campus->name_of_the_educational_Institution : 'our school';
                $message = urlencode("Dear Parent,\n\nGreetings from $schoolName.\n\nWe would like to discuss some important matters about your child $name. Please get in touch at your earliest convenience.");
