...
/* @var $searchModel app\modules\admin\models\search\TutorixSubscriptionYearSearch */
...
$this->title = Yii::t('app', 'Tutorix Subscription Years');
...
?>
<div class="tutorix-subscription-year-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Tutorix Subscription Year'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-tutorix-subscription-year']],
        'panel' => [
