...
/* @var $model app\modules\admin\models\search\ExamsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-exams-search">
    ...
    <?= $form->field($model, 'total_percentage_or_gpa')->textInput(['placeholder' => 'Total Percentage Or Gpa']) ?>
