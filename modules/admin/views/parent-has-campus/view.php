...
/* @var $model app\modules\admin\models\ParentHasCampus */

$this->title = $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Parent Has Campuses'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="parent-has-campus-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Parent Has Campus').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>ParentDetails<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnParentDetails = [
        ['attribute' => 'id', 'visible' => false],
        'user_id',
        'name_of_the_father',
        'name_of_the_mother',
    ...
    echo DetailView::widget([
        'model' => $model->patient,
        'attributes' => $gridColumnParentDetails    ]);
    ?>
    </div>
    </div>
    <div class="card">
