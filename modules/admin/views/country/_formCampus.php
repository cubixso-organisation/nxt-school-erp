...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'state_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\Notification::find()->orderBy('title')->asArray()->all(), 'id', 'title'),
                'options' => ['placeholder' => Yii::t('app', 'Choose Notification')],
            ],
            'columnOptions' => ['width' => '200px']
        ],
        'district_id' => [
        ...
        'subscription_type_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\SubscriptionTypes::find()->orderBy('title')->asArray()->all(), 'id', 'title'),
                'options' => ['placeholder' => Yii::t('app', 'Choose Subscription types')],
            ],
            'columnOptions' => ['width' => '200px']
        ],
        'activation_modules_id' => [
            'label' => 'Activation modules',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\ActivationModules::find()->orderBy('title')->asArray()->all(), 'id', 'title'),
                'options' => ['placeholder' => Yii::t('app', 'Choose Activation modules')],
            ],
            'columnOptions' => ['width' => '200px']
        ],
