...
/* @var $searchModel app\modules\admin\models\search\LeaveRequestsSearch */
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Student details', 'id' => 'grid-leave-requests-search-student_id']
                ],
                ...
                [
                    ...
                    'filterType' => GridView::FILTER_SELECT2,
                    'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\LeaveTypes::find()->asArray()->all(), 'id', 'title'),
                    'filterWidgetOptions' => [
                        'pluginOptions' => ['allowClear' => true],
                    ],
                    'filterInputOptions' => ['placeholder' => 'Leave types', 'id' => 'grid-leave-requests-search-leave_type_id']
                ],
                ...
                // [
                //     'attribute' => 'class_teacher_id',
                //     'label' => Yii::t('app', 'Class Teacher'),
                //     'value' => function ($model) {
                //         return $model->classTeacher->name;
                //     },
                //     'filterType' => GridView::FILTER_SELECT2,
                ...
                //         'pluginOptions' => ['allowClear' => true],
                //     ],
                //     'filterInputOptions' => ['placeholder' => 'Teacher details', 'id' => 'grid-leave-requests-search-class_teacher_id']
                // ],
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-leave-requests']],
                'panel' => [
