...
/* @var $model app\modules\admin\models\search\TutorixLecturesSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-tutorix-lectures-search">
    ...
    <?= $form->field($model, 'section_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\TutorixSections::find()->orderBy('id')->asArray()->all(), 'id', 'name'),
        'options' => ['placeholder' => Yii::t('app', 'Choose Tutorix sections')],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]); ?>

    <?= $form->field($model, 'lecture_id')->textInput(['placeholder' => 'Lecture']) ?>
