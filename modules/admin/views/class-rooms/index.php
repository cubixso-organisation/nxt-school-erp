...
/* @var $searchModel app\modules\admin\models\search\ClassRoomsSearch */
...
$this->title = Yii::t('app', 'Class Rooms');
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN|| \Yii::$app->user->identity->user_role==User::role_campus_sub_admin){ ?>
        <?= Html::a(Yii::t('app', 'Create Class Rooms'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
            ...
            'filter'  =>  (new ClassRooms())->getStateOptions(),
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-class-rooms']],
        'panel' => [
