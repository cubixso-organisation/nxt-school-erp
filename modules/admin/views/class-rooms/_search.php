...
/* @var $model app\modules\admin\models\search\ClassRoomsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-class-rooms-search">
    ...
    <?= $form->field($model, 'class_room_title')->textInput(['maxlength' => true, 'placeholder' => 'Class Room Title']) ?>
