<div class="form-group" id="add-class-sections">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'section_name' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowClassSections(' . $key . '); return false;', 'id' => 'class-sections-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Class Sections'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowClassSections()']),
        ]
    ]
]);
echo  "    </div>\n\n";
