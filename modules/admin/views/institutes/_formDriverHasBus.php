...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'driver_id' => ['type' => TabularForm::INPUT_TEXT],
        'bus_id' => [
            'label' => 'Bus details',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowDriverHasBus(' . $key . '); return false;', 'id' => 'driver-has-bus-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Driver Has Bus'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowDriverHasBus()']),
        ]
    ]
]);
echo  "    </div>\n\n";
