<div class="form-group" id="add-campus-web-settings">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'setting_key' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowCampusWebSettings(' . $key . '); return false;', 'id' => 'campus-web-settings-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Campus Web Settings'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowCampusWebSettings()']),
        ]
    ]
]);
echo  "    </div>\n\n";
