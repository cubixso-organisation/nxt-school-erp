...
$this->title = Yii::t('app', ' Absent Teacher Details');
    ...
    <div class="card">
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                // Static Today's Date Column
                [
                    'label' => Yii::t('app', 'Date'),
                    'value' => function () {
                        return date('Y-m-d'); // Change format as per requirement
                    },
                ],
            
                // Static Attendance Status Column
                [
                    'label' => Yii::t('app', 'Attendance Status'),
                    'value' => function () {
                        return 'Not marked'; // Static value
                    },
                ],
