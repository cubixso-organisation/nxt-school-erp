...
/* @var $searchModel app\modules\admin\models\DaycareActivitisSearch */
...
$this->title = Yii::t('app', 'Daycare Activitis');
...
?>
<div class="daycare-activitis-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Daycare Activitis'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-daycare-activitis-search-campus_id']
            ],
        ...
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\StaffDetails::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Staff details', 'id' => 'grid-daycare-activitis-search-student_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Teacher details', 'id' => 'grid-daycare-activitis-search-teacher_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-daycare-activitis']],
        'panel' => [
