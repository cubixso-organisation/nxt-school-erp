...
$this->title = $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Daycare Activitis'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="daycare-activitis-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Daycare Activitis').' '. Html::encode($this->title) ?></h2>
        </div>
