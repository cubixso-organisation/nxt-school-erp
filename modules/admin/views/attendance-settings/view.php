...
/* @var $model app\modules\admin\models\AttendanceSettings */

$this->title = $model->title;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Attendance Settings'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="attendance-settings-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Attendance Settings').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="row">
<?php
if($providerAttendanceTimeTables->totalCount){
    $gridColumnAttendanceTimeTables = [
    ...
    echo Gridview::widget([
        'dataProvider' => $providerAttendanceTimeTables,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-attendance-time-tables']],
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('app', 'Attendance Time Tables')),
        ],
        'export' => false,
        'columns' => $gridColumnAttendanceTimeTables
    ]);
}
