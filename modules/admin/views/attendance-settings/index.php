...
/* @var $searchModel app\modules\admin\models\search\AttendanceSettingsSearch */
...
$this->title = Yii::t('app', 'Attendance Settings');
...
?>
<div class="attendance-settings-index">
<div class="card">
       <div class="card-body">
...
if(empty($attendance_settings)) {
    echo  Html::a(Yii::t('app', 'Create Attendance Settings'), ['create'], ['class' => 'btn btn-success']);
}else{
    echo  Html::a(Yii::t('app', 'update Attendance Settings'), ['update?id='.$attendance_settings->id], ['class' => 'btn btn-success']);
    ...
    <b class="text-danger">Note: If no settings are configured, defaults to period wise attendance</b>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-attendance-settings-search-campus_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-attendance-settings']],
        'panel' => [
