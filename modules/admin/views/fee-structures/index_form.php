...
<?php 
    $gridColumn = [
        ...
        [
            ...
            'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\FeesTyps::find()
            ->andWhere(['campus_id'=>User::getCampusesByUser(Yii::$app->user->identity->id)])
            ->asArray()->all(), 'id', 'title'),
            'filterWidgetOptions' => [
                'pluginOptions' => ['allowClear' => true],
            ],
            'filterInputOptions' => ['placeholder' => 'title', 'id' => 'grid-fee-structures-search-title']
        ],
        ...
        [
                ...
                'value' => function($model){                   
                    return $model->feeType->fees_type_name;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\FeesTyps::find()
                ->andWhere(['campus_id'=>User::getCampusesByUser(Yii::$app->user->identity->id)])
                ...
                'filterInputOptions' => ['placeholder' => 'Fees typs', 'id' => 'grid-fee-structures-search-fee_type_id']
            ],
