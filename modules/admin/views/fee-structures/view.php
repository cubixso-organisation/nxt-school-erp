...
?>
<div class="fee-structures-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Fee Structures').' '. Html::encode($this->title) ?></h2>
        </div>
...
<?php 
    $gridColumn = [
        ...
        [
            'attribute' => 'campus.name_of_the_educational_Institution',
            'label' => Yii::t('app', 'Campus'),
        ],
        [
            'attribute' => 'feeType.fees_type_name',
        ...
        [
            'attribute' => 'classSection.section_name',
