...
<li class="submenu ">
   ...
   <ul>
      ...
      <li>
         <a href="<?= Url::to(['/admin/payment-details/fee-report-by-fee-type']) ?>" class="<?= Yii::$app->request->url == Url::to(['/admin/payment-details/fee-report-by-fee-type']) ? 'active' : '' ?>">Fee Report By Fee Structure</a>
      </li>
   </ul>
</li>
<li class="submenu ">
