...
/* @var $searchModel app\modules\admin\models\ExpensesSearch */
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-expenses-search-campus_id']
                ],
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Student details', 'id' => 'grid-expenses-search-student_id']
                ],
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-expenses']],
                'panel' => [
