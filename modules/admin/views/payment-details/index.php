...
<div class="payment-details-index">
    <div class="card">
        <div class="card-body">
            ...
            <?= $this->render('_student_search', ['model' => $searchModel]); ?>
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'value' => function ($model) {
                        if ($model->class) {
                            return isset($model->class->title)?$model->class->title:'';
                        } else {
                            return null;
                        }
                    },
                ...
                [
                    ...
                    'value' => function ($model) {
                        if ($model->section) {
                            return isset($model->section->section_name)?$model->section->section_name:'';
                        } else {
                            return null;
                        }
                    },
...
[
    'attribute' => 'student_id_search', // Keep the VIRTUAL ATTRIBUTE
    'label' => Yii::t('app', 'Student ID'),
    'value' => function ($model) {
        return $model->student_id;
    },
    // REMOVE 'filter' => true, AND REPLACE WITH MANUAL INPUT:
...
[                    'attribute' => 'student_id',
                ...
                [
                    ...
                    'value' => function ($model) {
                        return $model->student->parent->contact_number ?? "";
                    },
                ...
                [
                    ...
                    'value' => function ($model) {
                        ...
                        if (!empty($model->payFees)) {
                            return isset($model->payFees->feeStructures) ? $model->payFees->feeStructures->title : "";
                        } else {
                            return "";
                        }
                    },
                    ...
                    // 'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\PayFees::find()->where(['campus_id' => (new User())->getCampusesByUser(Yii::$app->user->identity->id)])->groupBy('fee_structures_id')
                    //     ->asArray()->all(), 'id', function ($model) {
                    //     $id = $model['id'];
                    //     $PayFees  = PayFees::find()->where(['id' => $id])->one();

                    //     return  isset($PayFees->feeStructures->title)?$PayFees->feeStructures->title:'';
                    // }),
                    'filterWidgetOptions' => [
                        'pluginOptions' => ['allowClear' => true],
                    ],
...
$feeStructures_id = $model->payFees->fee_structures_id ?? "";


                        $total_fee = (new PaymentDetails())->getTotalFeeByStudentId($student_id, $feeStructures_id);
                        return $total_fee;
