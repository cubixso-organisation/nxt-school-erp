...
<div class="form-pay-fees-search">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['payment-details-pending'],
        'method' => 'get',
    ]); ?>
    ...
    <?= $form->field($model, 'class_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\StudentClass::find()->where(['campus_id'=>(new User())->getCampusesByUser(Yii::$app->user->identity->id)])
