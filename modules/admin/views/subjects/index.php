...
/* @var $searchModel app\modules\admin\models\search\SubjectsSearch */
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filter'  => (new Subjects())->getSubjectTypeOptions(),
                    'filterType' => GridView::FILTER_SELECT2,
                    'filterWidgetOptions' => [
                        'pluginOptions' => ['allowClear' => true],
                    ],
                    'filterInputOptions' => ['placeholder' => 'subject_type', 'id' => 'grid-state-search-subject_type'],


                    'attribute' => 'subject_type',
                    'format' => 'raw',
                    'value' => function ($model) {
                        return $model->getSubjectTypeBadges();
                    },
                ...
                [
                    ...
                    'filter'  => (new Subjects())->getStateOptions(),
                    'filterType' => GridView::FILTER_SELECT2,
                    'filterWidgetOptions' => [
                        'pluginOptions' => ['allowClear' => true],
                    ],
