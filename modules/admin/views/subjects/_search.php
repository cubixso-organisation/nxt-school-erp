...
/* @var $model app\modules\admin\models\search\SubjectsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-subjects-search">
    ...
    <?= $form->field($model, 'subject_type')->textInput(['placeholder' => 'Subject Type']) ?>
