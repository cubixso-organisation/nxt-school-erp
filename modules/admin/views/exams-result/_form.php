...
<div class="exams-result-form">
    ...
    <?= $form->field($model, 'exams_result_id')->textInput(['placeholder' => 'Exams Result']) ?>
    ...
    <?= $form->field($model, 'marks_sheet')->textInput(['maxlength' => true, 'placeholder' => 'Marks Sheet']) ?>

    <?= $form->field($model, 'percentage_or_gpa')->rA(['placeholder' => 'Percentage Or Gpa']) ?>
