...
/* @var $model app\modules\admin\models\Grocery */
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Cashback Activity </a></li>
				...
				[ 
					...
					'value' => function ($data) {
						if($data->payment_type == 'Refferal Commision'){
							$trsn = Transaction::find()->where(['transaction_id' => $data->parent_trans_id])->all();
						    //var_dump($data->transactionid->parentuser["username"]); exit;
							return $data->transactionid->parentuser["username"]; //isset($data->transactionid->parentuser["username"]))?$data->transactionid->parentuser["username"]):$data->transactionid->parentuser["id"]) ; 
