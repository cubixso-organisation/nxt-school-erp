        ...
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Teacher Attenddence'), ['create'], ['class' => 'btn btn-success']) ?>
                <?php } ?>
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\TeacherDetails::find()->where(['campus_id' => (new User)->getCampusId()])->andWhere(['status' => TeacherDetails::STATUS_ACTIVE])->asArray()->all(), 'id', 'name'),
                    'filterWidgetOptions' => [
                ...
                [
                    'attribute' => 'teacher_present_date_and_time',
                    'value' => function ($model) {
                        return Yii::$app->formatter->asDatetime($model->teacher_present_date_and_time, 'php:Y-m-d H:i:s');
                    },
                    ...
                    'filterInputOptions' => ['placeholder' => 'Select date range...'],
                ],
                ...
                [
                    ...
                    'filter' => (new TeacherAttenddence())->getStateOptions(),
    'filterInputOptions' => [
        'class' => 'form-control',
