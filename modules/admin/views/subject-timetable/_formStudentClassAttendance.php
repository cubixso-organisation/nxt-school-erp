<div class="form-group" id="add-student-class-attendance">
<?php
...
echo TabularForm::widget([
    ...
    'formName' => 'StudentClassAttendance',
    ...
    'attributes' => [
        ...
        'teacher_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\TeacherDetails::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="fa fa-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowStudentClassAttendance(' . $key . '); return false;', 'id' => 'student-class-attendance-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="fa fa-plus"></i>' . Yii::t('app', 'Add Student Class Attendance'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowStudentClassAttendance()']),
        ]
    ]
]);
echo  "    </div>\n\n";
