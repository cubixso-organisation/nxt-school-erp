...
?>
<div class="subject-timetable-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Subject Timetable').' '. Html::encode($this->title) ?></h2>
        </div>
...
<?php 
    $gridColumn = [
        ...
        [
            'attribute' => 'subjectGroupSubject.id',
            'label' => Yii::t('app', 'Subject Group Subject'),
        ],
        [
...
?>
    ...
    <div class="row">
<?php
if($providerStudentClassAttendance->totalCount){
    $gridColumnStudentClassAttendance = [
    ...
    echo Gridview::widget([
        'dataProvider' => $providerStudentClassAttendance,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-student-class-attendance']],
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('app', 'Student Class Attendance')),
        ],
        'export' => false,
        'columns' => $gridColumnStudentClassAttendance
    ]);
}
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>SubjectGroupSubjects<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnSubjectGroupSubjects = [
        ['attribute' => 'id', 'visible' => false],
        'subject_group_id',
        'subject_id',
        [
    ...
    echo DetailView::widget([
        'model' => $model->subjectGroupSubject,
        'attributes' => $gridColumnSubjectGroupSubjects    ]);
    ?>
    </div>
    </div>
    <div class="card">
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>ClassRooms<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnClassRooms = [
        ['attribute' => 'id', 'visible' => false],
        [
            'attribute' => 'campus.id',
            'label' => Yii::t('app', 'Campus'),
    ...
    echo DetailView::widget([
        'model' => $model->room,
        'attributes' => $gridColumnClassRooms    ]);
    ?>
    </div>
    </div>
    <div class="card">
