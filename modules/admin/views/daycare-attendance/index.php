...
/* @var $searchModel app\modules\admin\models\DaycareAttendanceSearch */
...
$this->title = Yii::t('app', 'Daycare Attendances');
...
?>
<div class="daycare-attendance-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Daycare Attendance'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-daycare-attendance-search-campus_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Student details', 'id' => 'grid-daycare-attendance-search-student_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Teacher details', 'id' => 'grid-daycare-attendance-search-teacher_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-daycare-attendance']],
        'panel' => [
