...
/* @var $searchModel app\modules\admin\models\search\TutorixSectionsSearch */
...
$this->title = Yii::t('app', 'Tutorix Sections');
...
?>
<div class="tutorix-sections-index">
    <div class="card">
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Tutorix Sections'), ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Tutorix class', 'id' => 'grid-tutorix-sections-search-class_id']
                ],
                ...
                [
                    ...
                    'filter' => \yii\helpers\ArrayHelper::map(
                        \app\modules\admin\models\TutorixSubjects::find()
                            ->joinWith(['class' => function ($query) {
                                $query->from(['tutorix_class' => 'tutorix_class']); // Explicit alias for TutorixClass
                            }])
                            ->asArray()
                            ->all(),
                        'id',
                        function ($model) {
                            return $model['class']['name'] . ' - ' . $model['name'];
                        }
                    ),
                    'filterWidgetOptions' => [
                        'pluginOptions' => ['allowClear' => true],
                    ...
                    'filterInputOptions' => [
                        'placeholder' => 'Tutorix classes and subjects',
                        'id' => 'grid-tutorix-sections-search-subject_id'
                    ]
                ],
