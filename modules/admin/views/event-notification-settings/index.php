...
/* @var $searchModel app\modules\admin\models\search\EventNotificationSettingsSearch */
...
$this->title = Yii::t('app', 'Event Notification Settings');
...
?>
<div class="event-notification-settings-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Event Notification Settings'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
            ...
            'value' => function ($model) {
                return $model->getNotificationOptions()[$model->send_notification] ?? 'Unknown';
            },
        ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-event-notification-settings-search-campus_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-event-notification-settings']],
        'panel' => [
