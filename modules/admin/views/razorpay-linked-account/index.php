...
/* @var $searchModel app\modules\admin\models\search\RazorpayLinkedAccountSearch */
...
$this->title = Yii::t('app', 'Razorpay Linked Accounts');
...
?>
<div class="razorpay-linked-account-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Razorpay Linked Account'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-razorpay-linked-account-search-campus_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-razorpay-linked-account']],
        'panel' => [
