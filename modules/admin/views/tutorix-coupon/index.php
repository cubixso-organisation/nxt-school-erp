...
/* @var $searchModel app\modules\admin\models\search\TutorixCouponSearch */
...
$this->title = Yii::t('app', 'Tutorix Coupons');
...
?>
<div class="tutorix-coupon-index">
    <div class="card">
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Tutorix Coupon'), ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                // Add DatePicker filter for end_date
                [
                    'attribute' => 'end_date',
                    'value' => 'end_date',
                    'filter' => DatePicker::widget([
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-tutorix-coupon']],
                'panel' => [
