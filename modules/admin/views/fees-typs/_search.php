...
/* @var $model app\modules\admin\models\search\FeesTypsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-fees-typs-search">
    ...
    <?= $form->field($model, 'year_from')->textInput(['maxlength' => true, 'placeholder' => 'Year From']) ?>

    <?= $form->field($model, 'year_to')->textInput(['maxlength' => true, 'placeholder' => 'Year To']) ?>
