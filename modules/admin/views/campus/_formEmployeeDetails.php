...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'employ_name' => ['type' => TabularForm::INPUT_TEXT],
        'profile_picture' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'license_number' => ['type' => TabularForm::INPUT_TEXT],
        'del' => [
            'type' => 'raw',
            'label' => '',
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowEmployeeDetails(' . $key . '); return false;', 'id' => 'employee-details-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Employee Details'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowEmployeeDetails()']),
        ]
    ]
]);
echo  "    </div>\n\n";
