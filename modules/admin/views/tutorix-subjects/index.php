...
/* @var $searchModel app\modules\admin\models\search\TutorixSubjectsSearch */
...
$this->title = Yii::t('app', 'Tutorix Subjects');
...
?>
<div class="tutorix-subjects-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Tutorix Subjects'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Tutorix subjects', 'id' => 'grid-tutorix-subjects-search-class_id']
            ],
