...
/* @var $searchModel app\modules\admin\models\search\AcademicYearsSearch */
...
<div class="card">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN || \Yii::$app->user->identity->user_role==User::role_campus_sub_admin){ ?>
        <?= Html::a(Yii::t('app', 'Create Academic Years'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
            ...
            'filter'  =>  (new AcademicYears())->getStateOptions(),
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-academic-years']],
        'panel' => [
