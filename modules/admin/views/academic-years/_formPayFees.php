...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'remarks_of_pay_fee' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="fa fa-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowPayFees(' . $key . '); return false;', 'id' => 'pay-fees-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="fa fa-plus"></i>' . Yii::t('app', 'Add Pay Fees'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowPayFees()']),
        ]
    ]
]);
echo  "    </div>\n\n";
