...
/* @var $searchModel app\modules\admin\models\search\SubjectGroupsSearch */
...
$this->title = Yii::t('app', 'Subject Groups');
...
?>
<div class="subject-groups-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN || \Yii::$app->user->identity->user_role==User::role_campus_sub_admin){ ?>
        <?= Html::a(Yii::t('app', 'Create Subject Groups'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-subject-groups-search-campus_id']
            ],
        ...
        [
            ...
            [
                ...
                'filter'  =>  (new SubjectGroups())->getStateOptions(),
                'filterType' => GridView::FILTER_SELECT2,
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
