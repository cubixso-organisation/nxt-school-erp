...
?>
<div class="student-has-notice-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Student Has Notice').' '. Html::encode($this->title) ?></h2>
        </div>
...
<?php 
    $gridColumn = [
        ...
        [
            'attribute' => 'studentNoticeBoard.title',
...
?>
    ...
    <div class="card">
       <div class="card-body">
    <div class="row">
        <h4>StudentNoticeBoards<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnStudentNoticeBoards = [
        ['attribute' => 'id', 'visible' => false],
        'campus_id',
        'title',
        'description',
    ...
    echo DetailView::widget([
        'model' => $model->studentNoticeBoard,
        'attributes' => $gridColumnStudentNoticeBoards    ]);
    ?>
    </div>
    </div>
</div>
