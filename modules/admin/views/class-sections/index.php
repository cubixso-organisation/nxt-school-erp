...
/* @var $searchModel app\modules\admin\models\search\ClassSectionsSearch */
...
$this->title = Yii::t('app', 'Class Sections');
...
?>
<div class="class-sections-index">
    <div class="card">
        <div class="card-body">
            ...
            <p>
                <?php if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::role_campus_sub_admin || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) { ?>
                    <?= Html::a(Yii::t('app', 'Create Class Sections'), ['create'], ['class' => 'btn btn-success']) ?>
                <?php  } ?>
        ...
        <div class="card-body">
            ...
            $gridColumn = [
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Student class', 'id' => 'grid-class-sections-search-student_class_id']
                ],
                ...
                [
                    ...
                    'filterInputOptions' => ['placeholder' => 'Student Section', 'id' => 'grid-class-sections-search-section_name']
                ],
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            if (\Yii::$app->user->identity->user_role == User::ROLE_ADMIN || \Yii::$app->user->identity->user_role == User::role_campus_sub_admin || \Yii::$app->user->identity->user_role == User::ROLE_MANAGER || \Yii::$app->user->identity->user_role == User::ROLE_CAMPUS_ADMIN) {
            ...
            <?= GridView::widget([
                ...
                'columns' => $gridColumn,
                'pjax' => true,
                'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-class-sections']],
                'panel' => [
