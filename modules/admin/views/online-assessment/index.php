...
/* @var $searchModel app\modules\admin\models\OnlineAssessmentSearch */
...
?>
<div class="online-assessment-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a('Create Online Assessment', ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Campus', 'id' => 'grid-online-assessment-search-campus_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Subjects', 'id' => 'grid-online-assessment-search-subject_id']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Academic years', 'id' => 'grid-online-assessment-search-academic_year_id']
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-online-assessment']],
        'panel' => [
...
$.ajax({
      ...
      url: "/Nxt_backend/gii/default/status-change",
