...
?>
<div class="subscription-types-view">
<div class="card">
       <div class="card-body">
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Subscription Types').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="row">
<?php
if($providerCampus->totalCount){
    $gridColumnCampus = [
        ['class' => 'yii\grid\SerialColumn'],
            ['attribute' => 'id', 'visible' => false],
            [
                'attribute' => 'institute.title',
                'label' => Yii::t('app', 'Institute')
            ],
            'name_of_the_educational_Institution',
            [
                'attribute' => 'educationalInstitutionType.title',
                'label' => Yii::t('app', 'Educational Institution Type')
            ],
            [
            ...
            'aadhaar_of_the_authorized',
                        [
                'attribute' => 'activationModules.title',
                'label' => Yii::t('app', 'Activation Modules')
            ],
            'lat',
            'lng',
            'coordinates',
    ...
    echo Gridview::widget([
        'dataProvider' => $providerCampus,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-campus']],
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('app', 'Campus')),
        ],
        'export' => false,
        'columns' => $gridColumnCampus
    ]);
}
