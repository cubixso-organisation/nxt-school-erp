...
/* @var $searchModel app\modules\hostelmanagement\models\search\HostlerAttendanceSettingsSearch */
...
$this->title = Yii::t('app', 'Hostler Attendance Settings');
...
?>
<div class="hostler-attendance-settings-index">
<div class="card">
       <div class="card-body">
    ...
    <?php  if(\Yii::$app->user->identity->user_role==User::ROLE_ADMIN || \Yii::$app->user->identity->user_role==User::ROLE_CAMPUS_ADMIN){ ?>
        <?= Html::a(Yii::t('app', 'Create Hostler Attendance Settings'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php  } ?>
...
<?php 
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-hostler-attendance-settings']],
        'panel' => [
