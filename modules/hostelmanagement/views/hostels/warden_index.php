            ...
            <?= GridView::widget([
				...
				'value' => 'id',
                    ...
                    [
                        ...
                        'filter'  => (new User())->getWardenOptions(),
                        'filterType' => GridView::FILTER_SELECT2,
                        'filterWidgetOptions' => [
                            'pluginOptions' => ['allowClear' => true],
                        ],
                        'filterInputOptions' => ['placeholder' => 'Role', 'id' => 'grid-state-search-user_role'],
                    ...
                    [
                        ...
                        'buttons' => [
                            'view' => function ($url, $model, $key) {
                                // Customize the URL for the "view" action
                                $customUrl = Url::toRoute(['warden-view', 'id' => $model->id]);
