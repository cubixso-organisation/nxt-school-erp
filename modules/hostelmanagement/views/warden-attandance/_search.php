...
/* @var $model app\modules\hostelmanagement\models\search\WardenAttandanceSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-warden-attandance-search">
    ...
    <?= $form->field($model, 'campus_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(Campus::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
    ...
    <?= $form->field($model, 'hostel_id')->textInput(['placeholder' => 'Hostel']) ?>
