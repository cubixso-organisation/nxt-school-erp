...
/**
 * app\modules\hostelmanagement\models\search\FloorSearch represents the model behind the search form about `app\modules\hostelmanagement\models\Floor`.
 */
 class FloorSearch extends Floor
{
    ...
    {
        return [
            [['id', 'hostel_id', 'campus_id', 'no_of_rooms', 'status', 'created_user_id', 'updated_user_id'], 'integer'],
            [['name_of_floor', 'created_on', 'updated_on'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name_of_floor', $this->name_of_floor]);
    ...
    public function campusAdminSearch($params)
    {
        ...
        $query = Floor::find()->where(['or', ['campus_id' => $campusId], ['campus_id' => $campusIdByUser]]);
