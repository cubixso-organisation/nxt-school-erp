...
/**
 * This is the base model class for table "hostler_attendance_settings".
 *
 * @property integer $id
 ...
 */
class HostlerAttendanceSettings extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return 'hostler_attendance_settings';
    }
    ...
    /**
     * @inheritdoc
     * @return \app\modules\hostelmanagement\models\HostlerAttendanceSettingsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\hostelmanagement\models\HostlerAttendanceSettingsQuery(get_called_class());
    }
