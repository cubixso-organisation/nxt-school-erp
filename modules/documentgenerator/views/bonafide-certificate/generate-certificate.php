...
<div class="row">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-sm-4">
                                        <?= $form->field($model, 'section_name')->widget(DepDrop::classname(), [
                                            ...
                                            'pluginOptions' => [
                                                'placeholder' => 'Select...',
                                                'depends' => ['bonafidecertificate-id'],
                                    ...
                                    <div class="col-sm-4 mb-5">
                                        <?= $form->field($model, 'certificate_name')->widget(\kartik\widgets\Select2::classname(), [
                                            'data' => \yii\helpers\ArrayHelper::map(
                                                \app\modules\documentgenerator\models\BonafideCertificate::find()->where(['campus_id' => (new User)->getCampusId()])->all(),
                                                'id',
                                                'certificate_name'
                                            ),
    ...
    <script>
        $(document).ready(function() {
            $("#bonafidecertificate-class_room_title").on('change', function() {
