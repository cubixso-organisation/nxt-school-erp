            ...
            <div class="id-card-container" style="background-image: url(' . $backgroundImage . ');">
                <div class="id-card-content">
                    ...
                    <div class="student-details">
                        ...
                        <p>Class: ' . $student->studentClass->title .  '</p>
                        <p>Section: ' .  $student->section->section_name . '</p>
                        <p>DOB: ' . $student->date_of_birth . '</p>
                        <p>Blood Group: ' . $student->blood_group_id . '</p>
                    </div>
                </div>
            </div>';
    ...
    public function actionCreate()
    {
        ...
        if ($model->loadAll(Yii::$app->request->post())) {
            ...
            try {
                ...
                if ($model->save(false)) {
                    Yii::$app->session->setFlash('success', 'Template created succesfully');

                    return $this->redirect(['index']);
                } else {
                    Yii::$app->session->setFlash('error', 'Failed to save the ID card template.');
                }
            } catch (\Exception $e) {
