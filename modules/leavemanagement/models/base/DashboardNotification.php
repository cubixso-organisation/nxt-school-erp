...
/**
 * This is the base model class for table "dashboard_notification".
 *
 * @property integer $id
 ...
 */
class DashboardNotification extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'campus_id', 'title', 'description', 'icon', 'status', 'create_user_id', 'update_user_id'], 'required'],
            [['user_id', 'campus_id', 'status', 'create_user_id', 'update_user_id'], 'integer'],
    ...
    /**
     * @inheritdoc
     * @return \app\modules\leavemanagement\models\DashboardNotificationQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\leavemanagement\models\DashboardNotificationQuery(get_called_class());
    }
